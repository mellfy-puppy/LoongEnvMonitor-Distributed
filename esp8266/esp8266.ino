...
const char inTopic[]   = "/sys/k15u4pLbvWp/esp8266/thing/service/property/set";
const char outTopic[]  = "/sys/k15u4pLbvWp/esp8266/thing/event/property/post";
...
void setup() {
  ...
  mqttClient.setId("k15u4pLbvWp.esp8266|securemode=2,signmethod=hmacsha256,timestamp=1716211465634|");                    //mqtt 连接客户端id
  mqttClient.setUsernamePassword("esp8266&k15u4pLbvWp", "0eb481af18cb5b979fd10f723ea211ed40698de213da413e302bfd724b609811");        //mqtt 连接用户名、密码
